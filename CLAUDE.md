...
> **If you want zero-setup automatic installation, use Cursor.** If you prefer to work with Claude, the one-time manual setup below gives you equivalent routing and output quality for all 46 skills.
...
You have access to 46 domain-specific skill documents (uploaded as project files). Each skill covers a specific area of Salesforce development with detailed methodology, scoring rubrics, code patterns, and anti-patterns.
